                ...
                <div class="col-8 info-text-filme">
                    ...
                    <div class="select-menu">
                        <div class="select-btn">
                            <span class="span_btn-text">Data</span>
                        ...
                        <ul class="options">
                            <?php
                            foreach ($result_sessoes as $row_sessoes) {
                                extract($row_sessoes);
                                $dateSessao = $sessaoData;
                                $dateSessaoFormat = date("d-m-y", strtotime($dateSessao));
                            ?>
                                <li class="option">
                                    <span class="option-text"><?= $dateSessaoFormat; ?> || <?= $sessaoHorario; ?></span>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
